...
class PGameMemHelper:PMemHelper
{
public:
	PGameMemHelper():cr3(0),game_base(0),gamePid(0){
		//TODO
		/*
		1> Run the service
		2> Patch
		3> Call super construct
		4> close the handle
		5> unpatch
		6> uninstall service
		7> install and uninstall another serceice
